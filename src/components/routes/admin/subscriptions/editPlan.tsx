...
import { useEditSubscription, useSubscription } from "@/hooks/use-subscriptions"
...
function EditPlan({ plan, onSuccess }: { plan: Subscription, onSuccess: () => void }) {
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea {...field} placeholder='optional' value={field.value ?? undefined} disabled={isPending} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
